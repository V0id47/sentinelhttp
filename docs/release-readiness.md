...
| Frontend lint and Git history secrets | PASS locally | ESLint with TypeScript 6.0.3 passed; Gitleaks v8.30.1 scanned 2 public commits (~1.63 MB), no leaks; CI now enforces both |
